...
class CustomDoubleClick extends Component {
  constructor() {
    super();
...
CustomDoubleClick.defaultProps = {
  delay: 300,
  radius: 20,
  onDoubleClick: () => Alert.alert('onDoubleClick Tap Succeed'),
  onClick: () => Alert.alert('onClick Tap Succeed'),
};

CustomDoubleClick.propTypes = {
...
module.exports = CustomDoubleClick;
